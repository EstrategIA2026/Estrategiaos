...
// Estrateg[IA]: botoes com cantos medios (rounded-md), acento laranja
// Estrateg[IA] (#E63B16). Estilo "ghost" ganha glow laranja + lift no hover
// (efeito copiado do site).
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Acento Estrateg[IA] (laranja) para CTAs de destaque.
        brand:
          "bg-brand text-brand-foreground shadow-sm hover:bg-brand-hover scia-btn-ghost",
        destructive:
